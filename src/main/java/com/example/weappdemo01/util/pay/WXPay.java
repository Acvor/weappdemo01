...
import com.example.weappdemo01.util.sdk.WXPayUtil;
import com.example.weappdemo01.util.DateUtil;
...
public class WXPay {
    ...
    public static String scanCodeToPay(String auth_code) throws Exception {
        ...
        com.example.weappdemo01.util.sdk.WXPay wxpay = new com.example.weappdemo01.util.sdk.WXPay(config);
    ...
    下单：生成二维码
     */
    public static Map<String, String> unifiedOrder(String body, int total_fee) {
        Map<String, String> resultMap = new HashMap();
        String openid = "ouR0E1oP5UGTEBce8jZ_sChfH26g";
        MyConfig config = null;
        com.example.weappdemo01.util.sdk.WXPay wxpay = null;
        try {
            config = new MyConfig();
            wxpay = new com.example.weappdemo01.util.sdk.WXPay(config);
        } catch (Exception e) {
            e.printStackTrace();
        }
        //生成的随机字符串
...
//        data.put("attach","id,11111;price,18.00;amount,1;");
    ...
    public static void createQRCode(Map<String, String> map) throws Exception {
        ...
        File outputFile = new File("/var/www/html/wechatPay.jpg");
    ...
    public static Map<String,String> doOrderQuery(String out_trade_no) {
        ...
        try {
            ...
            com.example.weappdemo01.util.sdk.WXPay wxPay = new com.example.weappdemo01.util.sdk.WXPay(myConfig);
